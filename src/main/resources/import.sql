...
INSERT INTO empleados (DNI, apellido1, apellido2, direccion, fecha_nacim, foto, localidad, nombre, pais, provincia) VALUES('12312312D', 'Hernández', 'Centenero', 'Calle Huerta del Rey', '1999-12-24' , '',  'Valladolid', 'Miguel' , 'España' ,'Valladolid');
INSERT INTO empleados (DNI, apellido1, apellido2, direccion, fecha_nacim, foto, localidad, nombre, pais, provincia) VALUES('45645645E', 'Vega', 'Ejemplo', 'Calle de Ejemplo', '1992-12-10', '',  'Valladolid' , 'Leticia', 'España', 'Valladolid');
*/
