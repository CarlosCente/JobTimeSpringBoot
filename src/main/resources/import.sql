...
INSERT INTO incidencias (estado, fecha, mensaje, tipo, empleado_cod_empl,descripcion) VALUES ('1', '2020-01-25', 'Incidencia de Datos de dirección', '2', 2,'El usuario laura, ha modificado los siguientes datos de dirección:  el campo (Direccion), el nuevo valor es: (Calle la Peña),  el campo (Localidad), el nuevo valor es: (Villanueva del Campo),  el campo (Pais), el nuevo valor es: (Spain),  el campo (Provincia), el nuevo valor es: (Zamora)');
