...
INSERT INTO fichajes (empleado_cod_empl, fecha, hora_entrada, hora_salida, ip_origen, tiempo_total, finalizado) VALUES (4, '2020-02-04', '08:25', '16:00', '192.168.1.1', '08:00', true);
...
INSERT INTO incidencias (estado, fecha, mensaje, tipo, empleado_cod_empl,descripcion) VALUES ('1', '2020-01-25', 'Incidencia de Datos de dirección', '2', 2,'El usuario laura (Laura Ruiz Fernández), ha modificado los siguientes datos de dirección:  el campo (Direccion), el nuevo valor es: (Calle la Peña),  el campo (Localidad), el nuevo valor es: (Villanueva del Campo),  el campo (Pais), el nuevo valor es: (Spain),  el campo (Provincia), el nuevo valor es: (Zamora)');
INSERT INTO incidencias (estado, fecha, mensaje, tipo, empleado_cod_empl,descripcion) VALUES ('1', '2020-02-03', 'Incidencia de Fichaje de entrada', '1', 4,'El usuario miguel (Miguel Hernández Centenero),  ha creado una incidencia con su fichaje de entrada del día (03/02/2020) la hora correcta sería a las (8:00). Además el usuario ha añadido el siguiente comentario: Tuve problemas con la red.');
